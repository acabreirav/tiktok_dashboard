...
- [ ] Fase 1 — fetch mínimo (2-3 cuentas) ← **en curso** *(2026-07-07: `apify_client.py` + `fetch.py` listos con guardas de costo; falta que la persona corra la primera corrida con su token, inspeccionar el JSON crudo y escribir el normalizador)*
