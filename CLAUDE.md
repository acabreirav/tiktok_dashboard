...
*(2026-07-08, expansión a RM completa: base ampliada a 52 legisladores — se agregaron D8, D9, D12 y D14 (28 diputados, 15 con handle candidato pendiente de validación humana; scrape=no hasta que Álvaro valide). Sector "neutro" nuevo para PDG (Jiles, Contreras/Dr. File, Parisi, T. Ramírez). MAX_CUENTAS subido a 60; Álvaro decidió costear el crédito Apify extra (~38 cuentas semanales ≈ $4.5-5/mes, apenas sobre free tier). Decisión comercial: crecer cuanto antes en universo e Instagram — el histórico es el activo. Plan comercial en Notion: "Radar de Tracción — Plan comercial". Próximo tras validación: perfil-only de Instagram.)*
